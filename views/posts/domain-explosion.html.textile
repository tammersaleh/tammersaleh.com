...
!/system/images/original/Untitled.jpg!
...
_And each is responsible for a single @name@ column._
...
_Behavior, not vocabulary, dictates normalization._  The moment you add a @shipping_rate@ method to the @Product@ model, you know you should migrate to a @ShippingType@ class.  The moment you have to be able to modify that price at runtime, you move to a model.

h2. Simplest thing possible.

That's the beauty of the "BDD":http://behaviour-driven.org/ way.  BDD teaches you to write your specs first, and produce the _simplest thing possible_ in order to get them to pass.  It also keeps you focused on producing business value for your client - something a domain explosion definitely doesn't do.
