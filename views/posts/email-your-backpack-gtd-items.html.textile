...
Download "this script":/system/assets/email_todos.rb, change the constants at the top, and plop it on a server somewhere.  You should test it on the server it will live on by running @/usr/local/bin/ruby /home/tsaleh/bin/email_todos.rb@
