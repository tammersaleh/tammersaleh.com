...
!/system/images/original/rspec_output_1.jpg(rspec output)!
...
* Built-in mocking/stubbing system _(but see below)_
* *Ubiquity matters*: if you're going to bank on a new testing framework becoming the Rails standard, rSpec is probably it. _(but see below)_
