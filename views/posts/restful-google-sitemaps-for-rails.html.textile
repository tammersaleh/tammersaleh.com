...
%>old-world-map.jpg large%

I recently added a google sitemap to "tammersaleh.com":/.  I followed "Ilya Grigorik's great instructions":http://www.igvita.com/2006/11/24/google-yahoo-sitemaps-in-rails/, and while they worked peachily, they were a tad bit outdated (2006).  
...
The @as_a_visitor@ context is part of "Master May I":http://gemcutter.org/gems/master_may_i, and just ensures there's nobody logged in.  

Now, let's knock the Controller and View layers out.  Starting with the routes:
...
%<Webmaster_Tools_-_Sitemaps.jpg large%
