...
function curvyObject()
{
    ...
    var boxPadding = $(this.box).css("paddingTop");
    ...
    this.applyCorners = function()
    {
                    ...
                    if(((cc == "tr" || cc == "tl") && this.topContainer != null) || ((cc == "br" || cc == "bl") && this.bottomContainer != null))
                      {
						...
						if(this.bgImage == "")
                        	$(newCorner).css("backgroundColor",this.boxColour);
                        else
							$(newCorner).css("backgroundImage",this.bgImage);
						
                        switch(cc)
                        {
                            case "tl":
							$(newCorner).css({height:topMaxRadius - this.borderWidth,"margin-right":this.settings.tr.radius - (this.borderWidth*2), "border-left":this.borderString,"border-top":this.borderString,left:-this.borderWidth + "px"});
                            break;
                            case "tr":
							$(newCorner).css({height:topMaxRadius - this.borderWidth,"margin-left":this.settings.tl.radius - (this.borderWidth*2), "border-right":this.borderString,"border-top":this.borderString,left:this.borderWidth + "px", "background-position":"-" + (topMaxRadius + this.borderWidth) + "px 0px"});
                            break;
                            case "bl":
							$(newCorner).css({height:botMaxRadius - this.borderWidth,"margin-right":this.settings.br.radius - (this.borderWidth*2), "border-left":this.borderString,"border-bottom":this.borderString,left:-this.borderWidth + "px", "background-position":"-" + (this.borderWidth) + "px -" + (this.boxHeight + (botMaxRadius + this.borderWidth) ) + "px" });
                            break;
                            case "br":
							$(newCorner).css({height:botMaxRadius - this.borderWidth,"margin-left":this.settings.bl.radius - (this.borderWidth*2), "border-right":this.borderString,"border-bottom":this.borderString,left:this.borderWidth + "px", "background-position":"-" + (botMaxRadius + this.borderWidth) + "px -" + (this.boxHeight + (botMaxRadius + this.borderWidth) )+ "px" });
                            break;
                        };
                    };
                }
                    ...
                    
                    {
                        ...
                        
                        {
                            ...
                            switch(cc)
                            {
                                ...
                                break;
                                case "bl":
								$(pixelBar).css("background-position","-" + Math.abs((this.settings[cc].radius -pixelBarLeft -1) - this.borderWidth) + "px -" + Math.abs((this.boxHeight + this.settings[cc].radius + pixelBarTop) -this.borderWidth) + "px");
                                break;
        ...
        
        {
            ...
            
            {
                ...
                
                {
                    ...
                    {
                        case "tl":
						$(newFiller).css({	bottom:"0px",left:"0px","border-right":this.borderString	});
                        this.topContainer.appendChild(newFiller);
                        break;
                        case "tr":
						$(newFiller).css({	bottom:"0px",right:"0px","border-right":this.borderString	});
                        this.topContainer.appendChild(newFiller);
                        break;
                        case "bl":
						$(newFiller).css({	top:"0px",left:"0px","border-left":this.borderString	});
				...
				$(newFillerBar).css({	position:"relative","font-size":"1px",overflow:"hidden","background-color":this.boxColour,"background-image":this.bgImage	});
                switch(z)
                
                {
                    ...
                    
                    {
                        ...
                        {
							$(newFillerBar).css({	height:topMaxRadius - this.borderWidth,"margin-left":this.settings.tl.radius - this.borderWidth,"margin-right":this.settings.tr.radius - this.borderWidth,"border-top":this.borderString	});
						...
						$(this.box).css("background-position","0px -" + (topMaxRadius - this.borderWidth) + "px");
                    ...
                    
                    {
                        ...
                        {
							$(newFillerBar).css({	height:botMaxRadius - this.borderWidth + "px","margin-left":this.settings.bl.radius - this.borderWidth,"margin-right":this.settings.br.radius - this.borderWidth,"border-bottom":this.borderString	});
                        this.bottomContainer.appendChild(newFillerBar);
						
                            if(this.bgImage != "")
							$(newFillerBar).css("background-position","-" + (botMaxRadius + this.borderWidth) + "px -" + (this.boxHeight + (topMaxRadius + this.borderWidth)) + "px");
                            this.bottomContainer.appendChild(newFillerBar);
        ...
        
        {
            ...
            $(contentContainer).addClass = "autoPadDiv";
			...
			$(contentContainer).css("padding-bottom",botMaxRadius);
			
			$(contentContainer).css({"padding-left":this.boxPadding,	"padding-right":this.boxPadding });
